...
and varargs to make the API friendly. KotlinPoet offers models for classes, interfaces & objects 
(`TypeSpec`), properties (`PropertySpec`), functions & constructors (`FunSpec`), parameters 
