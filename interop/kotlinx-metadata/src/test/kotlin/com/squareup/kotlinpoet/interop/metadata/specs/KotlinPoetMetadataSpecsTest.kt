...
import com.squareup.kotlinpoet.interop.metadata.specs.MultiClassInspectorTest.ClassInspectorType.ELEMENTS
import com.squareup.kotlinpoet.interop.metadata.specs.MultiClassInspectorTest.ClassInspectorType.REFLECTIVE
...
class KotlinPoetMetadataSpecsTest : MultiClassInspectorTest() {
  ...
  fun supertype() {
    ...
    assertThat(typeSpec.trimmedToString()).isEqualTo(
      """
      public class Supertype : KotlinPoetMetadataSpecsTest.BaseType(), KotlinPoetMetadataSpecsTest.BaseInterface
      """.trimIndent()
    )
  }
  ...
  fun typeAliases() {
    ...
    assertThat(typeSpec.trimmedToString()).isEqualTo(
      ...
      public class TypeAliases(
        public val foo: TypeAliasName,
        public val bar: GenericTypeAlias
      )
      """.trimIndent()
    )
  ...
  fun nestedTypeAlias() {
    ...
    assertThat(typeSpec.trimmedToString()).isEqualTo(
      ...
      public class NestedTypeAliasTest {
        public val prop: NestedTypeAlias = throw NotImplementedError("Stub!")
      }
      """.trimIndent()
    )
  }
  ...
  fun overriddenThings() {
    ...
    assertThat(typeSpec.trimmedToString()).isEqualTo(
      """
      public abstract class OverriddenThings : KotlinPoetMetadataSpecsTest.OverriddenThingsBase(), KotlinPoetMetadataSpecsTest.OverriddenThingsInterface {
  ...
  fun enumWithAnnotation() {
    ...
    assertThat(typeSpec.trimmedToString()).isEqualTo(
      ...
      public enum class EnumWithAnnotation {
        FOO,
        @KotlinPoetMetadataSpecsTest.FieldAnnotation
        BAR,
        BAZ,
      }
      """.trimIndent()
  ...
  fun interfaces() {
    ...
    assertThat(subInterfaceSpec.trimmedToString()).isEqualTo(
      """
      public interface SubInterface : KotlinPoetMetadataSpecsTest.TestInterface {
    ...
    assertThat(implSpec.trimmedToString()).isEqualTo(
      """
      public class TestSubInterfaceImpl : KotlinPoetMetadataSpecsTest.SubInterface {
  ...
  fun complexCompanionObject() {
    ...
    assertThat(typeSpec.trimmedToString()).isEqualTo(
      ...
      public class ComplexCompanionObject {
        public companion object ComplexObject : KotlinPoetMetadataSpecsTest.CompanionBase(), KotlinPoetMetadataSpecsTest.CompanionInterface
      }
      """.trimIndent()
    )
  }
  ...
  fun annotationsAreCopied() {
    ...
    assertThat(typeSpec.trimmedToString()).isEqualTo(
      """
      public class AnnotationHolders @KotlinPoetMetadataSpecsTest.ConstructorAnnotation constructor() {
        @field:KotlinPoetMetadataSpecsTest.FieldAnnotation
        public var `field`: kotlin.String? = null

        @get:KotlinPoetMetadataSpecsTest.GetterAnnotation
        public var getter: kotlin.String? = null

        @KotlinPoetMetadataSpecsTest.HolderAnnotation
        @kotlin.jvm.JvmField
        public var holder: kotlin.String? = null

        @set:KotlinPoetMetadataSpecsTest.SetterAnnotation
        public var setter: kotlin.String? = null

        @KotlinPoetMetadataSpecsTest.ConstructorAnnotation
        public constructor(`value`: kotlin.String)

        @KotlinPoetMetadataSpecsTest.FunctionAnnotation
  ...
  @IgnoreForHandlerType(
    reason = "compile-testing can't handle class names with dashes, will throw " +
      "\"class file for com.squareup.kotlinpoet.interop.metadata.specs.test.Fuzzy\$ClassNesting\$-Nested not found\"",
    handlerType = ELEMENTS
  )
  @Test
  ...
  fun parameterAnnotations_reflective() {
    ...
    assertThat(typeSpec.trimmedToString()).isEqualTo(
      ...
      public class ParameterAnnotations(
        @property:KotlinPoetMetadataSpecsTest.CustomAnnotation(name = "${'$'}{'${'$'}'}a")
        @KotlinPoetMetadataSpecsTest.CustomAnnotation(name = "b")
        public val param1: kotlin.String,
        @KotlinPoetMetadataSpecsTest.CustomAnnotation(name = "2")
        param2: kotlin.String
      ) {
        public fun function(@KotlinPoetMetadataSpecsTest.CustomAnnotation(name = "woo") param1: kotlin.String): kotlin.Unit {
        }
      }
      """.trimIndent()
    )
  ...
  fun classAnnotations_reflective() {
    ...
    assertThat(typeSpec.trimmedToString()).isEqualTo(
      """
      @KotlinPoetMetadataSpecsTest.RuntimeCustomClassAnnotation(name = "Runtime")
  ...
  fun classAnnotations_elements() {
    ...
    assertThat(typeSpec.trimmedToString()).isEqualTo(
      """
      @KotlinPoetMetadataSpecsTest.BinaryCustomClassAnnotation(name = "Binary")
      @KotlinPoetMetadataSpecsTest.RuntimeCustomClassAnnotation(name = "Runtime")
      public class ClassAnnotations
      """.trimIndent()
    )
  ...
  fun typeAnnotations() {
    ...
    assertThat(typeSpec.trimmedToString()).isEqualTo(
      ...
      public class TypeAnnotations {
        public val foo: kotlin.collections.List<@KotlinPoetMetadataSpecsTest.TypeAnnotation kotlin.String> = throw NotImplementedError("Stub!")

        public fun <T> bar(input: @KotlinPoetMetadataSpecsTest.TypeAnnotation kotlin.String, input2: @KotlinPoetMetadataSpecsTest.TypeAnnotation (@KotlinPoetMetadataSpecsTest.TypeAnnotation kotlin.Int) -> @KotlinPoetMetadataSpecsTest.TypeAnnotation kotlin.String): kotlin.Unit {
        }
      }
      """.trimIndent()
    )
  ...
  fun backwardTypeVarReferences() {
    ...
    assertThat(typeSpec.trimmedToString()).isEqualTo(
      """
      public class Asset<A : KotlinPoetMetadataSpecsTest.Asset<A>> {
        public fun <D : KotlinPoetMetadataSpecsTest.Asset<D>, C : KotlinPoetMetadataSpecsTest.Asset<A>> function(): kotlin.Unit {
        }

        public class AssetIn<in C : KotlinPoetMetadataSpecsTest.Asset.AssetIn<C>>

        public class AssetOut<out B : KotlinPoetMetadataSpecsTest.Asset.AssetOut<B>>
      }
      """.trimIndent()
    )
  }
  ...
  fun modalities() {
    ...
    assertThat(abstractModalities.trimmedToString()).isEqualTo(
      """
      public abstract class AbstractModalities : KotlinPoetMetadataSpecsTest.ModalitiesInterface {
    ...
    assertThat(finalAbstractModalities.trimmedToString()).isEqualTo(
      """
      public abstract class FinalAbstractModalities : KotlinPoetMetadataSpecsTest.ModalitiesInterface {
    ...
    assertThat(modalities.trimmedToString()).isEqualTo(
      """
      public class Modalities : KotlinPoetMetadataSpecsTest.AbstractModalities() {
        public override val interfaceProp: kotlin.String? = null
