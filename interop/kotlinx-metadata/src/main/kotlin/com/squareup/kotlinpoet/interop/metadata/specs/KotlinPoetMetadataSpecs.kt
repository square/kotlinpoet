...
import com.squareup.kotlinpoet.interop.metadata.PropertyAccessorFlag
import com.squareup.kotlinpoet.interop.metadata.PropertyAccessorFlag.IS_EXTERNAL
import com.squareup.kotlinpoet.interop.metadata.PropertyAccessorFlag.IS_INLINE
import com.squareup.kotlinpoet.interop.metadata.PropertyAccessorFlag.IS_NOT_DEFAULT
import com.squareup.kotlinpoet.interop.metadata.declaresDefaultValue
import com.squareup.kotlinpoet.interop.metadata.hasAnnotations
import com.squareup.kotlinpoet.interop.metadata.hasGetter
import com.squareup.kotlinpoet.interop.metadata.hasSetter
import com.squareup.kotlinpoet.interop.metadata.isAbstract
import com.squareup.kotlinpoet.interop.metadata.isAnnotation
import com.squareup.kotlinpoet.interop.metadata.isClass
import com.squareup.kotlinpoet.interop.metadata.isCompanionObject
import com.squareup.kotlinpoet.interop.metadata.isConst
import com.squareup.kotlinpoet.interop.metadata.isCrossInline
import com.squareup.kotlinpoet.interop.metadata.isData
import com.squareup.kotlinpoet.interop.metadata.isDeclaration
import com.squareup.kotlinpoet.interop.metadata.isDelegated
import com.squareup.kotlinpoet.interop.metadata.isDelegation
import com.squareup.kotlinpoet.interop.metadata.isEnum
import com.squareup.kotlinpoet.interop.metadata.isEnumEntry
import com.squareup.kotlinpoet.interop.metadata.isExpect
import com.squareup.kotlinpoet.interop.metadata.isExternal
import com.squareup.kotlinpoet.interop.metadata.isFinal
import com.squareup.kotlinpoet.interop.metadata.isFun
import com.squareup.kotlinpoet.interop.metadata.isInfix
import com.squareup.kotlinpoet.interop.metadata.isInline
import com.squareup.kotlinpoet.interop.metadata.isInner
import com.squareup.kotlinpoet.interop.metadata.isInterface
import com.squareup.kotlinpoet.interop.metadata.isInternal
import com.squareup.kotlinpoet.interop.metadata.isLateinit
import com.squareup.kotlinpoet.interop.metadata.isNoInline
import com.squareup.kotlinpoet.interop.metadata.isObject
import com.squareup.kotlinpoet.interop.metadata.isOpen
import com.squareup.kotlinpoet.interop.metadata.isOperator
import com.squareup.kotlinpoet.interop.metadata.isPrimary
import com.squareup.kotlinpoet.interop.metadata.isPrivate
import com.squareup.kotlinpoet.interop.metadata.isProtected
import com.squareup.kotlinpoet.interop.metadata.isPublic
import com.squareup.kotlinpoet.interop.metadata.isReified
import com.squareup.kotlinpoet.interop.metadata.isSealed
import com.squareup.kotlinpoet.interop.metadata.isSuspend
import com.squareup.kotlinpoet.interop.metadata.isSynthesized
import com.squareup.kotlinpoet.interop.metadata.isTailRec
import com.squareup.kotlinpoet.interop.metadata.isVal
import com.squareup.kotlinpoet.interop.metadata.isVar
import com.squareup.kotlinpoet.interop.metadata.propertyAccessorFlags
import com.squareup.kotlinpoet.interop.metadata.specs.internal.ClassInspectorUtil
import com.squareup.kotlinpoet.interop.metadata.specs.internal.ClassInspectorUtil.createAnnotations
import com.squareup.kotlinpoet.interop.metadata.specs.internal.ClassInspectorUtil.createClassName
import com.squareup.kotlinpoet.interop.metadata.specs.internal.ClassInspectorUtil.toTreeSet
import com.squareup.kotlinpoet.interop.metadata.specs.internal.TypeParameterResolver
import com.squareup.kotlinpoet.interop.metadata.specs.internal.primaryConstructor
import com.squareup.kotlinpoet.interop.metadata.specs.internal.toAnnotationSpec
import com.squareup.kotlinpoet.interop.metadata.specs.internal.toTypeName
import com.squareup.kotlinpoet.interop.metadata.specs.internal.toTypeParameterResolver
import com.squareup.kotlinpoet.interop.metadata.specs.internal.toTypeVariableName
import com.squareup.kotlinpoet.interop.metadata.toKmClass
...
private fun KmClass.toTypeSpec(
  ...
  if (!isEnumEntry) {
    flags.computeVisibility { builder.addModifiers(it) }
...
private fun KmConstructor.toFunSpec(
  ...
  return FunSpec.constructorBuilder()
    .apply {
      ...
      flags.computeVisibility { addModifiers(it) }
      addParameters(
...
@KotlinPoetMetadataPreview
private fun Flags.computeVisibility(body: (KModifier) -> Unit) {
  val modifierVisibility = visibility
