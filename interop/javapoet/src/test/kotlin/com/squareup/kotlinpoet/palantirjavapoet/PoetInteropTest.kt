...
class PoetInteropTest {
  ...
  fun kotlinIntrinsicsMapCorrectlyToJava() {
    ...
    assertThat(ANY.toJTypeName()).isEqualTo(JClassName.OBJECT)
    ...
    assertThat(JClassName.OBJECT.toKTypeName()).isEqualTo(ANY)
  }
  ...
  fun wildcards() {
    ...
    assertThat(STAR.toJTypeName()).isEqualTo(JWildcardTypeName.subtypeOf(JClassName.OBJECT))
    assertThat(JWildcardTypeName.subtypeOf(JClassName.OBJECT).toKTypeName()).isEqualTo(STAR)
  }
