...
Note that KotlinPoet generates code which supports [explicit API mode](https://kotlinlang.org/docs/whatsnew14.html#explicit-api-mode-for-library-authors). Therefore, explicit `public` modifiers are always generated.
