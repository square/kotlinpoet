...
public final class TypeSpecTest {
  ...
  @Test public void basic() throws Exception {
    ...
    assertThat(toString(taco)).isEqualTo(""
        ...
        + "  }\n"
        + "}\n");
    assertEquals(260732178, taco.hashCode()); // update expected number if source changes
  }
  ...
  @Test public void methodThrows() throws Exception {
    ...
    assertThat(toString(taco)).isEqualTo(""
        ...
        + "\n"
        + "abstract class Taco {\n"
        + "  throwOne(): void throws IOException {\n"
        + "  }\n"
        + "\n"
        + "  throwTwo(): void throws IOException, SourCreamException {\n"
        + "  }\n"
        + "\n"
        + "  abstract abstractThrow(): void throws IOException;\n"
        + "\n"
        + "  native nativeThrow(): void throws IOException;\n"
        + "}\n");
  }
  ...
  @Test public void innerAnnotationInAnnotationDeclaration() throws Exception {
    ...
    assertThat(toString(bar)).isEqualTo(""
        ...
        + "\n"
        + "@interface Bar {\n"
        + "  value(): Deprecated default @Deprecated;\n"
        + "}\n"
    );
  }
  ...
  @Test public void intersectionType() {
    ...
    assertThat(toString(taco)).isEqualTo(""
        ...
        + "\n"
        + "class Taco {\n"
        + "  <T : Comparator & Serializable> getComparator(): T {\n"
        + "    return null;\n"
        + "  }\n"
        + "}\n");
  }
  ...
  @Test public void multipleMethodAddition() {
    ...
    assertThat(toString(taco)).isEqualTo(""
        ...
        + "\n"
        + "class Taco {\n"
        + "  public static getAnswer(): int {\n"
        + "    return 42\n"
        + "  }\n"
        + "\n"
        + "  /**\n"
        + "   * chosen by fair dice roll ;) */\n"
        + "  public getRandomQuantity(): int {\n"
        + "    return 4\n"
        + "  }\n"
        + "}\n");
  }
