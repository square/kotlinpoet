...
public final class TypeSpecTest {
  ...
  @Test public void anonymousInnerClass() throws Exception {
    ...
    assertThat(toString(taco)).isEqualTo(""
        ...
        + "        @Override\n"
        + "        public fun doSomething(bar: Bar): void {\n"
        + "          /* code snippets */\n"
        + "        }\n"
        + "      };\n"
        + "    }\n"
  ...
  @Test public void enumsMayDefineAbstractMethods() throws Exception {
    ...
    assertThat(toString(roshambo)).isEqualTo(""
        ...
        + "  CORN {\n"
        + "    @Override\n"
        + "    public fun fold(): void {\n"
        + "    }\n"
        + "  };\n"
        + "\n"
        + "  public abstract fun fold(): void;\n"
        + "}\n");
  }
  ...
  @Test public void methodThrows() throws Exception {
    ...
    assertThat(toString(taco)).isEqualTo(""
        ...
        + "\n"
        + "abstract class Taco {\n"
        + "  fun throwOne(): void throws IOException {\n"
        + "  }\n"
        + "\n"
        + "  fun throwTwo(): void throws IOException, SourCreamException {\n"
        + "  }\n"
        + "\n"
        + "  abstract fun abstractThrow(): void throws IOException;\n"
        + "\n"
        + "  native fun nativeThrow(): void throws IOException;\n"
        + "}\n");
  }
  ...
  @Test public void varargs() throws Exception {
    ...
    assertThat(toString(taqueria)).isEqualTo(""
        ...
        + "\n"
        + "class Taqueria {\n"
        + "  fun prepare(workers: int, vararg jobs: Runnable): void {\n"
        + "  }\n"
        + "}\n");
  }
  ...
  @Test public void nativeMethods() throws Exception {
    ...
    assertThat(toString(taco)).isEqualTo(""
        ...
        + "\n"
        + "  public static native fun alert(msg: String): void /*-{\n"
        + "    $wnd.alert(msg);\n"
        + "  }-*/;\n"
        + "}\n");
  }
  ...
  @Test public void multilineStatementWithAnonymousClass() throws Exception {
    ...
    assertThat(toString(taco)).isEqualTo(""
        ...
        + "  }\n"
        + "\n"
        + "  fun sortPrefix(list: List<String>, final length: int): void {\n"
        + "    Collections.sort(\n"
        + "        list,\n"
  ...
  @Test public void tryCatch() {
    ...
    assertThat(toString(taco)).isEqualTo(""
        ...
        + "\n"
        + "class Taco {\n"
        + "  fun addTopping(topping: Topping): void {\n"
        + "    try {\n"
